  ...
  function e(g, h) {
    ...
    !function (c, d) {
      ...
      var e = c.document,
        ...
        var q,
            r = this,
            s = a("./src/item")(r),
            t = a("./src/add-async")(r);q = { start: function start() {
          ...
          if (0 !== a.length) {
            if (b) return void t(a, b);var c = [],
                e = !1;a[0] === d && (a = [a]);for (var f = 0, g = a.length; f < g; f++) {
          ...
          var a = r.items,
              b = a.length;r.visibleItems = [], r.matchingItems = [], r.templater.clear();for (var c = 0; c < b; c++) {
    ...
    b.exports = function (a) {
      var b,
          ...
          d,
          e,
          f = { resetList: function resetList() {
        ...
        }, setSearchString: function setSearchString(b) {
    ...
    var d = function d(a) {
      var b,
        ...
        for (var d = 0, e = c.length; d < e; d++) {
          var f;if (c[d].data) for (var g = 0, h = c[d].data.length; g < h; g++) {
            b.setAttribute("data-" + c[d].data[g], "");
          } else c[d].attr && c[d].name ? (f = a.utils.getByClass(b, c[d].name, !0), f && f.setAttribute(c[d].attr, "")) : (f = a.utils.getByClass(b, c[d], !0), f && (f.innerHTML = ""));f = void 0;
        }return b;
        ...
        if (void 0 === b) {
          ...
          }var h = document.getElementById(a.item);if (h) return h;
        }
      }, this.get = function (b, d) {
        c.create(b);for (var e = {}, f = 0, g = d.length; f < g; f++) {
          var h;if (d[f].data) for (var i = 0, j = d[f].data.length; i < j; i++) {
            e[d[f].data[i]] = a.utils.getAttribute(b.elm, "data-" + d[f].data[i]);
          } else d[f].attr && d[f].name ? (h = a.utils.getByClass(b.elm, d[f].name, !0), e[d[f].name] = h ? a.utils.getAttribute(h, d[f].attr) : "") : (h = a.utils.getByClass(b.elm, d[f], !0), e[d[f]] = h ? h.innerHTML : "");h = void 0;
        }return e;
        ...
        var e = function e(b) {
          for (var c = 0, d = a.valueNames.length; c < d; c++) {
            if (a.valueNames[c].data) {
              ...
              if (a.valueNames[c].attr && a.valueNames[c].name && a.valueNames[c].name == b) return a.valueNames[c];if (a.valueNames[c] === b) return b;
            }
          }
        },
            f = function f(c, d) {
        ...
        };if (!c.create(b)) for (var g in d) {
          d.hasOwnProperty(g) && f(g, d[g]);
        }
      }, this.create = function (a) {
        if (void 0 !== a.elm) return !1;if (void 0 === b) throw new Error("The list need to have at list one item on init otherwise you'll have to add a template.");var d = b.cloneNode(!0);return d.removeAttribute("id"), a.elm = d, c.set(a, a.values()), !0;
    ...
    function d(a) {
      if (!a || !a.nodeType) throw new Error("A DOM element reference is required");this.el = a, this.list = a.classList;
    }var e = a("./index-of"),
        f = /\s+/,
        g = Object.prototype.toString;b.exports = function (a) {
      return new d(a);
    ...
    var d = window.addEventListener ? "addEventListener" : "attachEvent",
        ...
        g = a("./to-array");c.bind = function (a, b, c, e) {
    ...
    b.exports = function (a, b) {
      var c = a.getAttribute && a.getAttribute(b) || null;if (!c) for (var d = a.attributes, e = d.length, f = 0; f < e; f++) {
    ...
    b.exports = function () {
      return document.getElementsByClassName ? function (a, b, c) {
        ...
        var d = [],
            e = "*";null === a && (a = document);for (var f = a.getElementsByTagName(e), g = f.length, h = new RegExp("(^|\\s)" + b + "(\\s|$)"), i = 0, j = 0; i < g; i++) {
    ...
    var d = [].indexOf;b.exports = function (a, b) {
      if (d) return a.indexOf(b);for (var c = 0; c < a.length; ++c) {
        if (a[c] === b) return c;
      }return -1;
    };
  }, {}], 15: [function (a, b, c) {
    b.exports = function (a, b, c) {
      var d,
        ...
        if (r < s) return -1;if (r > s) return 1;
      }for (var u = 0, v = p.length, w = q.length, x = Math.max(v, w); u < x; u++) {
        if (d = t(p[u] || "", v), e = t(q[u] || "", w), isNaN(d) !== isNaN(e)) return isNaN(d) ? 1 : -1;if (/[^\x00-\x80]/.test(d + e) && d.localeCompare) {
    ...
    function d(a) {
      ...
      if ("undefined" == typeof a) return [];if (null === a) return [null];if (a === window) return [window];if ("string" == typeof a) return [a];if (d(a)) return a;if ("number" != typeof a.length) return [a];if ("function" == typeof a && a instanceof Function) return [a];for (var b = [], c = 0; c < a.length; c++) {
